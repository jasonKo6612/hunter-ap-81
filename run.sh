...
##### JVM 參數
export JAVA_OPTS="-server -Xms64m -Xmx64m -XX:+UseParallelGC -XX:+UseParallelGC  -Djava.library.path=/usr/local/lib"
...
/usr/bin/sudo -u root $JAVA_HOME/bin/java $JAVA_OPTS -jar $JAVA_NAME